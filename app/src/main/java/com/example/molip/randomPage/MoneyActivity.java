    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                LinearLayout.LayoutParams p1 = new LinearLayout.LayoutParams(700, ViewGroup.LayoutParams.WRAP_CONTENT);
...
//                            ratios.add(tmp);
                ...
                String avgText = "Average : " + avgDouble + "원";
